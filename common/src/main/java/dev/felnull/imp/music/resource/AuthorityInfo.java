...
public class AuthorityInfo implements TagSerializable {
  ...
  public AuthorityInfo(
    ...
    UUID owner,
    String ownerName,
    AuthorityType initialAuthority
  ) {
    this(
      publiced,
      owner,
  ...
  public AuthorityInfo(
    ...
    UUID owner,
    String ownerName,
    Map<UUID, AuthorityType> authority,
    AuthorityType initialAuthority
  ) {
  ...
  public void load(CompoundTag tag) {
    ...
    this.initialAuthority = AuthorityType.getByName(
      tag.getString("InitialAuthority")
    );
  }
  ...
  public boolean equals(Object o) {
    ...
    return (
      publiced == that.publiced &&
      Objects.equals(owner, that.owner) &&
      Objects.equals(ownerName, that.ownerName) &&
      Objects.equals(authority, that.authority) &&
      initialAuthority == that.initialAuthority
    );
  }
