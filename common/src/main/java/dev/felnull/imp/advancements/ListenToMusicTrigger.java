...
public class ListenToMusicTrigger
  extends SimpleCriterionTrigger<ListenToMusicTrigger.TriggerInstance>
{
  ...
  protected TriggerInstance createInstance(
    ...
    boolean remote =
      jo.has("remote") && jo.get("remote").getAsBoolean();
    boolean kamesuta =
      jo.has("kamesuta") && jo.get("kamesuta").getAsBoolean();
  ...
  public void trigger(
    ...
    this.trigger(serverPlayer, triggerInstance ->
      triggerInstance.matches(radio, remote, kamesuta)
    );
  }
    ...
    extends AbstractCriterionTriggerInstance
  {
    ...
    public static TriggerInstance listen(
      boolean radio,
      boolean remote,
      boolean kamesuta
    ) {
