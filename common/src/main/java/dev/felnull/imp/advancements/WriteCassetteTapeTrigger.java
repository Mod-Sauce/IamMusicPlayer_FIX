...
public class WriteCassetteTapeTrigger
  extends SimpleCriterionTrigger<
    WriteCassetteTapeTrigger.TriggerInstance
  >
{
  ...
  protected TriggerInstance createInstance(
    ...
    ItemPredicate itemPredicate = ItemPredicate.fromJson(
      jsonObject.get("item")
    );
    ...
    extends AbstractCriterionTriggerInstance
  {
    ...
    public JsonObject serializeToJson(
      ...
      if (this.item != null) jsonObject.add(
        "item",
        this.item.serializeToJson()
      );
      return jsonObject;
    }
