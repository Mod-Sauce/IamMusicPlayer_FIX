...
public class IMPPackets {
  ...
  public static final ResourceLocation MUSIC_SYNC =
    new ResourceLocation(IamMusicPlayer.MODID, "music_sync");
  public static final ResourceLocation MUSIC_PLAYLIST_ADD =
    new ResourceLocation(IamMusicPlayer.MODID, "music_playlist_add");
  public static final ResourceLocation MUSIC_PLAYLIST_EDIT =
    new ResourceLocation(IamMusicPlayer.MODID, "music_playlist_edit");
  public static final ResourceLocation MUSIC_PLAYLIST_CHANGE_AUTHORITY =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "music_playlist_change_authority"
    );
  public static final ResourceLocation MUSIC_ADD =
    new ResourceLocation(IamMusicPlayer.MODID, "music_add");
  public static final ResourceLocation MUSIC_EDIT =
    new ResourceLocation(IamMusicPlayer.MODID, "music_edit");
  public static final ResourceLocation MUSIC_OR_PLAYLIST_DELETE =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "music_or_playlist_delete"
    );
  public static final ResourceLocation MUSIC_RING_READY =
    new ResourceLocation(IamMusicPlayer.MODID, "music_ring_ready");
  public static final ResourceLocation MUSIC_RING_READY_RESULT =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "music_ring_ready_result"
    );
  public static final ResourceLocation MUSIC_RING_STATE =
    new ResourceLocation(IamMusicPlayer.MODID, "music_ring_state");
  public static final ResourceLocation MUSIC_RING_UPDATE_RESULT =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "music_ring_update_result"
    );
  public static final ResourceLocation MULTIPLE_MUSIC_ADD =
    new ResourceLocation(IamMusicPlayer.MODID, "multiple_music_add");
  public static final ResourceLocation HAND_LID_CYCLE =
    new ResourceLocation(IamMusicPlayer.MODID, "hand_lid_cycle");
  ...
  public static void init() {
    NetworkManager.registerReceiver(
      ...
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicSyncRequestMessage(
          new MusicSyncRequestMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_PLAYLIST_ADD,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicPlayListAddMessage(
          new MusicPlayListMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_PLAYLIST_EDIT,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicPlayListEditMessage(
          new MusicPlayListMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_PLAYLIST_CHANGE_AUTHORITY,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicPlayListChangeAuthority(
          new MusicPlayListChangeAuthorityMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_ADD,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicAddMessage(
          new MusicMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_EDIT,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicEditMessage(
          new MusicMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_RING_READY_RESULT,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicReadyResultMessage(
          new MusicRingReadyResultMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_RING_UPDATE_RESULT,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicUpdateResultMessage(
          new MusicRingUpdateResultMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_OR_PLAYLIST_DELETE,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMusicOrPlayListDeleteMessage(
          new MusicOrPlayListDeleteMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MULTIPLE_MUSIC_ADD,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onMultipleMusicAdd(
          new MultipleMusicAddMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      HAND_LID_CYCLE,
      (friendlyByteBuf, packetContext) ->
        ServerMessageHandler.onHandLidCycleMessage(
          new LidCycleMessage(friendlyByteBuf),
          packetContext
        )
    );
  }
  ...
  public static void clientInit() {
    NetworkManager.registerReceiver(
      ...
      MUSIC_SYNC,
      (friendlyByteBuf, packetContext) ->
        ClientMessageHandler.onMusicSyncResponseMessage(
          new MusicSyncResponseMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_RING_READY,
      (friendlyByteBuf, packetContext) ->
        ClientMessageHandler.onMusicRingReadyResponseMessage(
          new MusicReadyMessage(friendlyByteBuf),
          packetContext
        )
    );
    NetworkManager.registerReceiver(
      ...
      MUSIC_RING_STATE,
      (friendlyByteBuf, packetContext) ->
        ClientMessageHandler.onMusicRingStateResponseMessage(
          new MusicRingStateMessage(friendlyByteBuf),
          packetContext
        )
    );
  }
  ...
  public static class LidCycleMessage implements PacketMessage {
    ...
    public LidCycleMessage(FriendlyByteBuf buf) {
      ...
      this.itemLocation = PlayerItemLocations.loadFromTag(
        buf.readNbt()
      );
    }

    public LidCycleMessage(
      UUID boomboxId,
      PlayerItemLocation itemLocation
    ) {
    ...
    implements PacketMessage
  {
    ...
    public MusicPlayListChangeAuthorityMessage(FriendlyByteBuf bf) {
      ...
      this.authorityType = AuthorityInfo.AuthorityType.getByName(
        bf.readUtf()
      );
      this.blockEntityExistence = BlockEntityExistence.read(bf);
    }

    public MusicPlayListChangeAuthorityMessage(
      UUID playlist,
      UUID player,
      AuthorityInfo.AuthorityType authorityType,
    ...
    implements PacketMessage
  {
    ...
    public MultipleMusicAddMessage(
      UUID playlist,
      List<Music> musics,
      BlockEntityExistence blockEntityExistence
    ) {
    ...
    public FriendlyByteBuf toFBB(FriendlyByteBuf buf) {
      ...
      buf.writeNbt(
        IMPNbtUtil.writeMusics(new CompoundTag(), "Musics", musics)
      );
      this.blockEntityExistence.write(buf);
      return buf;
    }
    ...
    implements PacketMessage
  {
    ...
    public MusicOrPlayListDeleteMessage(
      UUID playListID,
      UUID musicID,
      BlockEntityExistence blockEntityExistence,
      boolean music
  ...
  public static record MusicRingUpdateResultMessage(
    UUID uuid,
    UUID waitId,
    MusicRingResponseStateType ringResponseStateType
  ) implements PacketMessage {
    public MusicRingUpdateResultMessage(FriendlyByteBuf bf) {
      this(
        bf.readUUID(),
        bf.readUUID(),
        bf.readEnum(MusicRingResponseStateType.class)
      );
    }
  ...
  public static record MusicRingStateMessage(
    UUID uuid,
    UUID waitId,
    MusicRingStateType stateType,
    long elapsed,
    CompoundTag tracker
  ) implements PacketMessage {
    public MusicRingStateMessage(
      UUID uuid,
      UUID waitId,
      MusicRingStateType stateType
    ) {
    ...
    public MusicRingStateMessage(FriendlyByteBuf bf) {
      this(
        bf.readUUID(),
        bf.readUUID(),
        bf.readEnum(MusicRingStateType.class),
        bf.readLong(),
        bf.readNbt()
      );
    }
    ...
    implements PacketMessage
  {
    ...
    public MusicRingReadyResultMessage(
      UUID waitID,
      UUID uuid,
      boolean result,
      boolean retry,
  ...
  public static record MusicReadyMessage(
    UUID waitId,
    UUID uuid,
    MusicSource source,
    CompoundTag tracker,
    ...
    public MusicReadyMessage(FriendlyByteBuf bf) {
      this(
        bf.readUUID(),
        bf.readUUID(),
        TagSerializable.loadSavedTag(bf.readNbt(), new MusicSource()),
        bf.readNbt(),
        bf.readLong()
      );
    }
  ...
  public static class MusicMessage implements PacketMessage {
    ...
    public MusicMessage(FriendlyByteBuf bf) {
      ...
      this.image = TagSerializable.loadSavedTag(
        bf.readNbt().getCompound("Image"),
        new ImageInfo()
      );
      this.source = TagSerializable.loadSavedTag(
        bf.readNbt().getCompound("Source"),
        new MusicSource()
      );
      this.blockEntityExistence = BlockEntityExistence.read(bf);
    }
  ...
  public static class MusicPlayListMessage implements PacketMessage {
    ...
    public MusicPlayListMessage(
      String name,
      ImageInfo image,
      boolean publiced,
      boolean initMember,
      List<UUID> invitePlayers,
      BlockEntityExistence blockEntityExistence,
      List<Music> importMusics
    ) {
      this(
        UUID.randomUUID(),
        name,
    ...
    implements PacketMessage
  {
    ...
    public MusicSyncResponseMessage(
      MusicSyncType syncType,
      UUID syncId,
    ...
    implements PacketMessage
  {
    ...
    public MusicSyncRequestMessage(
      MusicSyncType syncType,
      UUID syncId
    ) {
      this.syncType = syncType;
