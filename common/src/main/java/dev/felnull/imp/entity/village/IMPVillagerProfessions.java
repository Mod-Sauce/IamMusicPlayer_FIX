...
public class IMPVillagerProfessions {
  ...
  public static final RegistrySupplier<VillagerProfession> DJ =
    register("dj", IMPPoiType.DJ, SoundEvents.LANTERN_PLACE);
  ...
  private static RegistrySupplier<VillagerProfession> register(
    ...
    return VILLAGER_PROFESSIONS.register(name, () ->
      new VillagerProfession(
        new ResourceLocation(IamMusicPlayer.MODID, name).toString(),
