...
public class IMPBlockTagProviderWrapper
  extends BlockTagProviderWrapper
{

  public IMPBlockTagProviderWrapper(
  ...
  public void generateTag(
    IntrinsicTagProviderAccess<Block> providerAccess
  ) {
    providerAccess
