...
public class IMPPoiTypeTagProviderWrapper
  extends PoiTypeTagProviderWrapper
{

  public IMPPoiTypeTagProviderWrapper(
  ...
  public void generateTag(
    TagProviderAccess<
      PoiType,
      TagAppenderWrapper<PoiType>
    > providerAccess
  ) {
    providerAccess
      .tag(PoiTypeTags.ACQUIRABLE_JOB_SITE)
      .add(IMPPoiType.getResourceKey(IMPPoiType.DJ.get()));
  }
}
