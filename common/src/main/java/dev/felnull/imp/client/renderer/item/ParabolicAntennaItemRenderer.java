...
public class ParabolicAntennaItemRenderer
  implements BEWLItemRenderer
{
  ...
  public void render(
    ...
    if (
      IMPHoliday.isXmas() && IMPModels.XMAS_ANTENNA != null
    ...
    if (name.equalsIgnoreCase("kamesuta")) {
      ...
      name.equalsIgnoreCase("f.c.o.h") ||
      name.equalsIgnoreCase("fcoh")
    ) {
    ...
    if (IMPHoliday.isXmas()) {
      if (
        IMPModels.XMAS_ANTENNA_SIDE != null
      ) OERenderUtils.renderModel(
        poseStack,
        vc,
        IMPModels.XMAS_ANTENNA_SIDE.get(),
        i,
        i1
      );
      ...
      if (
        ...
        poseStack,
        vc,
        IMPModels.XMAS_ANTENNA_TAMA.get(),
        i,
        i1
      );
    }
