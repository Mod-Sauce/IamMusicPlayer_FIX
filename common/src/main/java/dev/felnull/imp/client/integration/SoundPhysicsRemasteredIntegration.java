  ...
  extends BaseIntegration
{
  ...
  public static final SoundPhysicsRemasteredIntegration INSTANCE =
    new SoundPhysicsRemasteredIntegration();
  private final Map<
    Pair<UUID, UUID>,
    SoundPhysicsRemasteredAudio
  > audios = new HashMap<>();
  ...
  public void onSound(
    ...
    var e = audios.computeIfAbsent(k, n ->
      new SoundPhysicsRemasteredAudio()
    );
