...
public class PlayImageRenderer {
  ...
  private static final Pattern YOUTUBE_THUMBNAIL_URL_REGEX = Pattern.compile(
    "https://i.ytimg.com/vi/.+/hqdefault.jpg"
  );
  private static final Pattern SOUND_CLOUD_URL_REGEX = Pattern.compile(
  ...
  private Pair<ResourceLocation, Vec2> getImageTexture(
    ...
    if (imageInfo.getImageType() == ImageInfo.ImageType.URL) {
      ...
      imageInfo.getImageType() == ImageInfo.ImageType.YOUTUBE_THUMBNAIL
    ) {
      var loc = OETextureUtils.getAndLoadURLTextureAsync(
        String.format(YOUTUBE_THUMBNAIL_URL, imageInfo.getIdentifier()),
        cash
      ...
      imageInfo.getImageType() == ImageInfo.ImageType.SOUND_CLOUD_ARTWORK
    ) {
