  ...
  extends ImageNameBaseMMMonitor
{
  ...
  protected static final Component PUBLIC_ST_TEXT =
    Component.translatable("imp.text.publishingSettings");
  protected static final Component INITIAL_AUTHORITY_TEXT =
    Component.translatable("imp.text.initialAuthority");
  protected static final Component PUBLIC_RDO_TEXT =
    Component.translatable("imp.radioButton.public");
  protected static final Component PRIVATE_RDO_TEXT =
    Component.translatable("imp.radioButton.private");
  protected static final Component READONLY_RDO_TEXT =
    Component.translatable("imp.radioButton.readonly");
  protected static final Component MEMBER_RDO_TEXT =
    Component.translatable("imp.radioButton.member");

  public PlayListBaseMMMonitor(
  ...
  protected PublishingType getPublishingType(
    ...
    return PublishingType.getTypeByName(
      musicManagerBlockEntity.getPublishing(mc.player)
    );
  }
  ...
  protected InitialAuthorityType getInitialAuthorityType(
    ...
    return InitialAuthorityType.getTypeByName(
      musicManagerBlockEntity.getInitialAuthority(mc.player)
    );
  }
