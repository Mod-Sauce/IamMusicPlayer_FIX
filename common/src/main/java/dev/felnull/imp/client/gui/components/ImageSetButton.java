  ...
  public void renderWidget(
    ...
    if (type == ImageSetType.PLAYER_FACE) {
      OERenderUtils.drawPlayerFace(
        ...
        (float) getX() + ((float) width - 11f) / 2f,
        (float) getY() + ((float) height - 11f) / 2f,
        11
      );
    } else {
      OERenderUtils.drawTexture(
        ...
        (float) getX() + ((float) width - 11f) / 2f,
        (float) getY() + ((float) height - 11f) / 2f,
        73 + (type == ImageSetType.DELETE ? 11 : 0),
        19,
        11,
        11
      );
