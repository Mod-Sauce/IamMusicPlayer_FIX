...
public class YoutubeMusicMedia extends LavaPlayerBaseMusicMedia {
  ...
  private static final Component YT_ENTER_TEXT =
    Component.translatable("imp.text.enterText.youtube");
  ...
  public boolean match(AudioTrack track) {
    return (
      track.getSourceManager() instanceof YoutubeAudioSourceManager
    );
  }
