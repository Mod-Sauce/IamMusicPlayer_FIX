...
public class RadioBMonitor extends PlayBackBaseBMonitor {
  ...
  private static final ResourceLocation BACK_BG_TEXTURE =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "textures/gui/container/boombox/monitor/playback_back.png"
    );
  private static final Component LOADING_STREAM_TEXT =
    Component.translatable("imp.text.streamLoading");
  private static final Component PLAYING_STREAM_TEXT =
    Component.translatable("imp.text.streamPlaying");
  private static final Component NON_PROGRESS_TEXT =
    Component.literal("--:--/--:--");
  private SmartButton backButton;

  public RadioBMonitor(
  ...
  public void init(int leftPos, int topPos) {
    ...
    this.backButton = this.addRenderWidget(
      new SmartButton(
        ...
        n -> setMonitor(BoomboxData.MonitorType.RADIO_SELECT)
      )
    );
  ...
  public void render(
    ...
    if (
      ...
      getScreen().getBoomBoxData().isPlaying()
    ) {
