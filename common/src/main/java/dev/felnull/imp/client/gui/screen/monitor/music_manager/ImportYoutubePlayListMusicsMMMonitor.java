  ...
  extends ImportYoutubePlayListBaseMMMonitor
{
  ...
  public ImportYoutubePlayListMusicsMMMonitor(
  ...
  protected void onImport() {
    ...
    if (
      getImportPlayListMusicCount() > 0 && !ipl.isEmpty()
      ...
      try {
        ...
        mc.submit(() -> {
          if (
            ...
            IMPPackets.MULTIPLE_MUSIC_ADD,
            new IMPPackets.MultipleMusicAddMessage(
