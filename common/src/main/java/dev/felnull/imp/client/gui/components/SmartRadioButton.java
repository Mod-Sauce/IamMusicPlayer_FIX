...
public class SmartRadioButton
  extends RadioButton
  implements IIMPSmartRender
{

  private static final TextureRegion SRDIO_TEXTURE =
  ...
  public SmartRadioButton(
    ...
    @Nullable Consumer<RadioButton> onPress,
    @NotNull Supplier<Set<RadioButton>> group
  ) {
    super(x, y, 20, 20, title, onPress, group, true, SRDIO_TEXTURE);
  }

  @Override
  public void drawTextBase(
