...
public class MenuCDMonitor extends CassetteDeckMonitor {
  ...
  private static final Component WRITE = Component.translatable(
    "imp.button.write"
  );
  private static final Component PLAYBACK = Component.translatable(
    "imp.button.playback"
  );

  public MenuCDMonitor(
  ...
  public void init(int leftPos, int topPos) {
    ...
    this.addRenderWidget(
      new SmartButton(
        getStartX() + (width - 100) / 2,
        getStartY() + (height - 14 * 3) / 2,
        100,
        14,
        WRITE,
        n -> {
