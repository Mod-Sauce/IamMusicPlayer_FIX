...
public class DebugSpeakerRangeRenderer {
  ...
  public static void render(
    ...
    for (MusicPlayerAccess player : me.getMusicPlayers().values()) {
      for (MusicSpeakerAccess speaker : player
        .getSpeakers()
        .values()) {
        renderSpeaker(
          poseStack,
  ...
  private static void renderSpeaker(
    ...
    double distance = listener.distanceTo(
      speaker.getInfo().getPosition()
    );
  ...
  private static void renderLine(
    ...
    vertexConsumer
      .vertex(pose.pose(), stX + x, stY + y, stZ + z)
      .color(r, g, b, a)
      .normal(pose.normal(), nx, ny, nz)
      .endVertex();
    vertexConsumer
      .vertex(pose.pose(), enX + x, enY + y, enZ + z)
      .color(r, g, b, a)
      .normal(pose.normal(), nx, ny, nz)
      .endVertex();
  }
