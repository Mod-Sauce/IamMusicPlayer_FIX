  ...
  extends Monitor<BoomboxBlockEntity>
{
  ...
  public static void firstInit() {
    ...
    registerMonitors(
      BoomboxData.MonitorType.PLAYBACK,
      PlaybackBMonitor::new
    );
    registerMonitors(
      BoomboxData.MonitorType.RADIO,
      RadioBMonitor::new
    );
    registerMonitors(
      BoomboxData.MonitorType.REMOTE_PLAYBACK,
      RemotePlayBackBMonitor::new
    );
    registerMonitors(
      BoomboxData.MonitorType.RADIO_SELECT,
      RadioSelectBMonitor::new
    );
    registerMonitors(
      BoomboxData.MonitorType.REMOTE_PLAYBACK_SELECT,
      RemotePlayBackSelectBMonitor::new
    );
  }
  ...
  public static BoomboxMonitor createdBoomBoxMonitor(
