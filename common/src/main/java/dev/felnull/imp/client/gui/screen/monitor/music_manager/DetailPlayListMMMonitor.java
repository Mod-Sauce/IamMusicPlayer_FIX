...
public class DetailPlayListMMMonitor extends PlayListBaseMMMonitor {
  ...
  private static final ResourceLocation DETAIL_PLAY_LIST_TEXTURE =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "textures/gui/container/music_manager/monitor/detail_play_list.png"
    );
  private static final Component MEMBER_TEXT = Component.translatable(
    "imp.text.member"
  );
  private static final Component EDIT_TEXT = Component.translatable(
    "imp.button.edit"
  );
  private static final Component AUTHORITY_TEXT =
    Component.translatable("imp.button.authority");
  private static final Component DELETE_TEXT = Component.translatable(
    "imp.button.delete"
  ).withStyle(ChatFormatting.DARK_RED);
  private static final Component EXIT_TEXT = Component.translatable(
    "imp.button.exit"
  ...
  public DetailPlayListMMMonitor(
  ...
  public void init(int leftPos, int topPos) {
    ...
    this.editButton = this.addRenderWidget(
      new SmartButton(
    ...
    this.deleteButton = this.addRenderWidget(
      new SmartButton(
        getStartX() + width - 5 - 87,
        getStartY() + 180,
        87,
        15,
        DELETE_TEXT,
    ...
    this.exitButton = this.addRenderWidget(
      new SmartButton(
        getStartX() + width - 5 - 87,
        getStartY() + 180,
        87,
        ...
        n -> {
          if (
            ...
            IMPPackets.MUSIC_OR_PLAYLIST_DELETE,
            new IMPPackets.MusicOrPlayListDeleteMessage(
              getSelectedPlayList(musicManagerBlock),
              UUID.randomUUID(),
    ...
    this.publishingRadio = this.addRenderWidget(
    ...
    this.initAuthRadio = this.addRenderWidget(
      new SmartRadioButton(
        getStartX() + 189,
        getStartY() + 140,
        getInitAuthText(),
    ...
    this.memberPlayersFixedButtonsList = addRenderWidget(
      new MemberPlayersFixedListWidget(
        getStartX() + 189,
        getStartY() + 23,
        175,
        100,
        Component.translatable("imp.fixedList.memberPlayers"),
        5,
        memberPlayers,
        (widget, item) -> {},
        this.memberPlayersFixedButtonsList,
  ...
  public void renderAppearance(
    ...
    if (pl != null) {
      pls = new ArrayList<>(
        pl.getAuthority().getPlayersAuthority().keySet()
      );
      pls.sort(
        Comparator.comparingInt(o ->
          pl.getAuthority().getAuthorityType((UUID) o).getLevel()
        ).reversed()
      );
    }
    ...
    renderFixedListSprite(
      ...
      (
        ...
        if (pl != null) renderSmartTextSprite(
          poseStack1,
          multiBufferSource,
          pl.getAuthority().getAuthorityType(entry).getText(),
          x + h + 3f,
          y + 11f,
          z + OERenderUtils.MIN_BREADTH * 3,
          onPxW,
    ...
    if (canEdit(blockEntity)) renderSmartButtonSprite(
      poseStack,
      multiBufferSource,
      width - 95 - 87,
      180,
    ...
    if (canDelete(blockEntity)) renderSmartButtonSprite(
      poseStack,
      multiBufferSource,
      width - 5 - 87,
      180,
  ...
  private Component getInitAuthText(
    ...
    if (pl != null) {
      if (
        pl.getAuthority().getInitialAuthority() ==
  ...
  private Component getPublishingText(
    ...
    var pl = getSelectedMusicPlayList(musicManagerBlockEntity);
    if (pl != null) {
      if (pl.getAuthority().isPublic()) return PUBLIC_RDO_TEXT;
      else return PRIVATE_RDO_TEXT;
    }
    return Component.literal("");
  }
