...
public class SoundCloudMusicMedia extends LavaPlayerBaseMusicMedia {
  ...
  private static final Component SC_ENTER_TEXT =
    Component.translatable("imp.text.enterText.soundcloud");
  ...
  public boolean match(AudioTrack track) {
    return (
      track.getSourceManager() instanceof SoundCloudAudioSourceManager
    );
  }
