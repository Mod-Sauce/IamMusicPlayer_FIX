...
public class IMPMusicMedias {
    ...
    public static final YoutubeMusicMedia YOUTUBE = new YoutubeMusicMedia(
        "youtube"
    );
    public static final SoundCloudMusicMedia SOUNDCLOUD =
        new SoundCloudMusicMedia("soundcloud");
    public static final HttpMusicMedia HTTP = new HttpMusicMedia("http");
    public static final NeteaseMusicMedia NETEASE_MUSIC = new NeteaseMusicMedia(
        "netease"
    );
    ...
    public static final WebDAVMusicMedia WEBDAV = new WebDAVMusicMedia(
        "webdav"
    );
    ...
    public static void init() {
        ...
        if (
            !Platform.isDevelopmentEnvironment() || !Platform.isForgeLike()
