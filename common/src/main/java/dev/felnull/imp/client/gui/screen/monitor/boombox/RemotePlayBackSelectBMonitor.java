...
public class RemotePlayBackSelectBMonitor extends BoomboxMonitor {
  ...
  protected static final ResourceLocation REMOTE_PLAYBACK_SELECT_TEXTURE =
    new ResourceLocation(
      IamMusicPlayer.MODID,
      "textures/gui/container/boombox/monitor/remote_playback_select.png"
    );
  ...
  public RemotePlayBackSelectBMonitor(
  ...
  public void init(int leftPos, int topPos) {
    ...
    this.remotePlayListFixedButtonsList = this.addRenderWidget(
      new RemotePlayListFixedListWidget(
        getStartX() + 1,
        getStartY() + 1,
        musicPlayLists,
        (widget, item) -> setSelectPlaylist(item.getUuid()),
        this.remotePlayListFixedButtonsList,
        musicPlayList ->
          musicPlayList.getUuid().equals(getSelectPlaylist())
      )
    );

    this.remoteMusicsFixedButtonsList = this.addRenderWidget(
      new RemoteMusicsFixedListWidget(
        getStartX() + 70,
        getStartY() + 1,
        musics,
        (widget, item) -> {
  ...
  public void render(
    ...
    OERenderUtils.drawTexture(
      REMOTE_PLAYBACK_SELECT_TEXTURE,
      guiGraphics.pose(),
      getStartX(),
      getStartY(),
      0f,
  ...
  public void renderAppearance(
    ...
    renderFixedListSprite(
      ...
      (
        ...
        renderSmartButtonBoxSprite(
          ...
          onPxH,
          monitorHeight,
          entry.getUuid().equals(getSelectPlaylist(data))
        );
        float sx = 1;
        ...
        renderSmartTextSprite(
          ...
          onPxH,
          monitorHeight,
          getDefaultRenderTextScale() * 0.7f,
          i1
        );
      }
    );
    ...
    renderFixedListSprite(
      ...
      onPxH,
      monitorHeight,
      getSyncManager().getMusics(getSelectPlaylist(data)),
      5,
      (
        poseStack12,
        multiBufferSource12,
