...
public class LavaPlayerLoader {
  ...
  private static final Logger LOGGER = LogManager.getLogger(
    LavaPlayerLoader.class
  );
  private static final String LAVA_NATIVE_DIR = "lava-natives-2.2.6";
  ...
  public static NativeLibraryLoader create(
  ...
  public static NativeLibraryLoader createFiltered(
    Class<?> classLoaderSample,
    String libraryName,
    ...
    return new NativeLibraryLoader(
      libraryName,
      systemFilter,
      new IMPSystemNativeLibraryProperties(libraryName, systemFilter),
      bp
    );
  }

  public static Path getNaiveLibraryFolder() {
    return IMPPaths.getNaiveLibraryFolder(LAVA_NATIVE_DIR);
  }
}
