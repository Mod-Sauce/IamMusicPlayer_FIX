...
public class DetailMusicMMMonitor extends MusicBaseMMMonitor {
  ...
  private boolean canEdit(
    ...
    return (
      m != null &&
      m.getOwner().equals(mc.player.getGameProfile().getId())
    );
  }
  ...
  @Override
  protected @NotNull String getMusicAuthor(
  ...
  @Override
  protected @NotNull String getMusicLoaderType(
    @NotNull MusicManagerBlockEntity musicManagerBlockEntity
  ) {
    var m = getSelectedMusic(musicManagerBlockEntity);
    if (m != null) return m.getSource().getLoaderType();
    return "";
  }
  ...
  @Override
  protected @NotNull MusicSource getMusicSource(
  ...
  @Nullable
  private UUID getSelectedPlayList(
    MusicManagerBlockEntity musicManagerBlockEntity
  ) {
