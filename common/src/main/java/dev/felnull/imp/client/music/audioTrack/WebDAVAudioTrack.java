...
public class WebDAVAudioTrack extends HttpAudioTrack {
    private final AudioTrackInfo originInfo;

    public WebDAVAudioTrack(AudioTrackInfo trackInfo, MediaContainerDescriptor containerTrackFactory, HttpAudioSourceManager sourceManager) {
