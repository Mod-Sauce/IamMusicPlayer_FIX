...
public abstract class IMPBaseContainerScreen<
  T extends OEBEBaseMenu
> extends OEBEContainerBasedScreen<T> {

  public IMPBaseContainerScreen(
  ...
  public boolean isPowered() {
    if (
      getBlockEntity() instanceof IMPBaseEntityBlockEntity impBase
